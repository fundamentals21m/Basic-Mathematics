...
export const section45Questions: SectionQuizQuestion[] = [
  ...
  },
  {
    id: 2,
    difficulty: 'easy',
    question: 'Is f(x) = x² even, odd, or neither?',
    options: ['Even', 'Odd', 'Neither', 'Both'],
    correctIndex: 0,
    explanation: 'f(-x) = (-x)² = x² = f(x), so f is even.'
  },
  {
    id: 3,
    difficulty: 'easy',
  ...
  // Medium questions (5)
  {
    id: 6,
    difficulty: 'medium',
    question: 'Is f(x) = x³ - x even, odd, or neither?',
    options: ['Odd', 'Even', 'Neither', 'Both'],
    correctIndex: 0,
    explanation: 'f(-x) = -x³ + x = -(x³ - x) = -f(x), so f is odd.'
  },
  {
    id: 7,
    difficulty: 'medium',
    question: 'Find the x-intercepts of f(x) = x² - 4.',
    options: ['x = ±2', 'x = ±4', 'x = 2', 'x = 4'],
    correctIndex: 0,
    explanation: 'Set f(x) = 0: x² - 4 = 0, so x² = 4, giving x = ±2.'
  },
  {
    id: 8,
    difficulty: 'medium',
  ...
  },
  {
    id: 9,
    difficulty: 'medium',
    question: 'What is the vertex of y = (x - 1)² - 4?',
    options: ['(1, -4)', '(-1, -4)', '(1, 4)', '(-1, 4)'],
    correctIndex: 0,
    explanation: 'Vertex form y = a(x - h)² + k gives vertex (h, k) = (1, -4).'
  },
  {
    id: 10,
    difficulty: 'medium',
    question: 'On what interval is f(x) = x² decreasing?',
    options: ['(-∞, 0)', '(0, ∞)', '(-∞, ∞)', 'Nowhere'],
    correctIndex: 0,
    explanation: 'The parabola x² decreases for x < 0 and increases for x > 0.'
  },
  ...
  },
  {
    id: 13,
    difficulty: 'hard',
    question: 'Find the horizontal asymptote of f(x) = (2x + 1)/(x - 3).',
    options: ['y = 2', 'y = 0', 'y = -1/3', 'y = 3'],
    correctIndex: 0,
    explanation: 'As x → ∞, (2x + 1)/(x - 3) ≈ 2x/x = 2. Horizontal asymptote is y = 2.'
  },
  {
    id: 14,
    difficulty: 'hard',
    question: 'If f(x) = x² + 1 is even, is g(x) = f(x - 1) even?',
    options: ['No', 'Yes', 'Cannot determine', 'Sometimes'],
    correctIndex: 0,
    explanation: 'g(x) = (x-1)² + 1. g(-x) = (-x-1)² + 1 = (x+1)² + 1 ≠ g(x) in general. So g is not even.'
  },
  {
    id: 15,
    difficulty: 'hard',
    question: 'How many times does y = x³ - 3x + 1 cross the x-axis?',
    options: ['3 times', '1 time', '2 times', '0 times'],
    correctIndex: 0,
    explanation: 'f(x) = x³ - 3x + 1. f(-2) = -8 + 6 + 1 = -1 < 0, f(0) = 1 > 0, f(1) = -1 < 0, f(2) = 3 > 0. Three sign changes means 3 roots.'
  }
];
