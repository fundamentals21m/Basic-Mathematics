...
export const section53Questions: SectionQuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['13', '4 - 9i²', '-5', '4 + 9'],
    correctIndex: 0,
    explanation: 'z · z̄ = a² + b² = 4 + 9 = 13.'
  },
  {
    id: 10,
    difficulty: 'medium',
  ...
  // Hard questions (5)
  {
    id: 11,
    difficulty: 'hard',
    question: 'Compute 1/(1 + i).',
    options: ['(1 - i)/2', '1 - i', '(1 + i)/2', '2/(1 + i)'],
    correctIndex: 0,
    explanation: '1/(1+i) = (1-i)/((1+i)(1-i)) = (1-i)/2.'
  },
  {
    id: 12,
    difficulty: 'hard',
  ...
  },
  {
    ...
    difficulty: 'hard',
    question: 'Solve z² = -1.',
    options: ['z = ±i', 'z = ±1', 'z = i only', 'No solution'],
    correctIndex: 0,
    explanation: 'z² = -1 means z = i or z = -i, since i² = (-i)² = -1.'
  },
  {
    id: 14,
    difficulty: 'hard',
    question: 'If z = 3 - 4i, compute z · z̄.',
    options: ['25', '9 + 16', '-7', '7 - 24i'],
    correctIndex: 0,
    explanation: 'z · z̄ = (3)² + (4)² = 9 + 16 = 25.'
  },
  {
    id: 15,
    difficulty: 'hard',
    question: 'Find (2 + i)/(1 - i) in the form a + bi.',
    options: ['1/2 + 3i/2', '3/2 + i/2', '1 + 2i', '2 - i'],
    correctIndex: 0,
    explanation: 'Multiply by (1+i)/(1+i): ((2+i)(1+i))/2 = (2 + 2i + i + i²)/2 = (1 + 3i)/2 = 1/2 + 3i/2.'
  }
];
